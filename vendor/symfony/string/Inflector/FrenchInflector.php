 ...
 */
namespace PHPStanBodyscan202405\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'PHPStanBodyscan202405\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'PHPStanBodyscan202405\\Mes\\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'PHPStanBodyscan202405\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'PHPStanBodyscan202405\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'PHPStanBodyscan202405\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'PHPStanBodyscan202405\\Mon\\1'],
        // Default rule
        ['/s$/i', ''],
    ];
