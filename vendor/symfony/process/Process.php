...
use PHPStanBodyscan202501\Symfony\Component\Process\Exception\InvalidArgumentException;
use PHPStanBodyscan202501\Symfony\Component\Process\Exception\LogicException;
use PHPStanBodyscan202501\Symfony\Component\Process\Exception\ProcessFailedException;
use PHPStanBodyscan202501\Symfony\Component\Process\Exception\ProcessSignaledException;
use PHPStanBodyscan202501\Symfony\Component\Process\Exception\ProcessStartFailedException;
use PHPStanBodyscan202501\Symfony\Component\Process\Exception\ProcessTimedOutException;
use PHPStanBodyscan202501\Symfony\Component\Process\Exception\RuntimeException;
use PHPStanBodyscan202501\Symfony\Component\Process\Pipes\UnixPipes;
use PHPStanBodyscan202501\Symfony\Component\Process\Pipes\WindowsPipes;
/**
...
class Process implements \IteratorAggregate
{
    ...
    private function buildShellCommandline($commandline) : string
    {
        ...
        if ('\\' === \DIRECTORY_SEPARATOR && isset($commandline[0][0]) && \strlen($commandline[0]) === \strcspn($commandline[0], ':/\\')) {
            ...
            $commandline[0] = (self::$executables[$commandline[0]] = self::$executables[$commandline[0]] ?? (new ExecutableFinder())->find($commandline[0])) ?? $commandline[0];
        }
