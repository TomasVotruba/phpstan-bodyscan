 ...
 */
namespace PHPStanBodyscan202405\Symfony\Component\Process;

use PHPStanBodyscan202405\Symfony\Component\Process\Exception\InvalidArgumentException;
use PHPStanBodyscan202405\Symfony\Component\Process\Exception\LogicException;
use PHPStanBodyscan202405\Symfony\Component\Process\Exception\ProcessFailedException;
use PHPStanBodyscan202405\Symfony\Component\Process\Exception\ProcessSignaledException;
use PHPStanBodyscan202405\Symfony\Component\Process\Exception\ProcessStartFailedException;
use PHPStanBodyscan202405\Symfony\Component\Process\Exception\ProcessTimedOutException;
use PHPStanBodyscan202405\Symfony\Component\Process\Exception\RuntimeException;
use PHPStanBodyscan202405\Symfony\Component\Process\Pipes\UnixPipes;
use PHPStanBodyscan202405\Symfony\Component\Process\Pipes\WindowsPipes;
/**
...
class Process implements \IteratorAggregate
{
    ...
    public function start(?callable $callback = null, array $env = []) : void
    {
        ...
        try {
            $process = @\proc_open(\is_array($commandline) ? \implode(' ', \array_map('escapeshellarg', $commandline)) : $commandline, $descriptors, $this->processPipes->pipes, $this->cwd, $envPairs, $this->options);
        } finally {
            if ($this->ignoredSignals && \function_exists('pcntl_sigprocmask')) {
