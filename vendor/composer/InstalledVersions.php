 ...
 */
namespace PHPStanBodyscan202406\Composer;

use PHPStanBodyscan202406\Composer\Autoload\ClassLoader;
use PHPStanBodyscan202406\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('PHPStanBodyscan202406\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
