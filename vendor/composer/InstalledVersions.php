 ...
 */
namespace PHPStanBodyscan202501\Composer;

use PHPStanBodyscan202501\Composer\Autoload\ClassLoader;
use PHPStanBodyscan202501\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('PHPStanBodyscan202501\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
