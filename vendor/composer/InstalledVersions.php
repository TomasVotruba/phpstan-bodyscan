 ...
 */
namespace PHPStanBodyscan202405\Composer;

use PHPStanBodyscan202405\Composer\Autoload\ClassLoader;
use PHPStanBodyscan202405\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('PHPStanBodyscan202405\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
