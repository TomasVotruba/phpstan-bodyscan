...
namespace PHPStanBodyscan202406\Illuminate\Container;

use ArrayAccess;
use Closure;
use Exception;
use PHPStanBodyscan202406\Illuminate\Contracts\Container\BindingResolutionException;
use PHPStanBodyscan202406\Illuminate\Contracts\Container\CircularDependencyException;
use PHPStanBodyscan202406\Illuminate\Contracts\Container\Container as ContainerContract;
use LogicException;
use ReflectionClass;
