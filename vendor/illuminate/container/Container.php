...
namespace PHPStanBodyscan202501\Illuminate\Container;

use ArrayAccess;
use Closure;
use Exception;
use PHPStanBodyscan202501\Illuminate\Contracts\Container\BindingResolutionException;
use PHPStanBodyscan202501\Illuminate\Contracts\Container\CircularDependencyException;
use PHPStanBodyscan202501\Illuminate\Contracts\Container\Container as ContainerContract;
use PHPStanBodyscan202501\Illuminate\Contracts\Container\ContextualAttribute;
use LogicException;
