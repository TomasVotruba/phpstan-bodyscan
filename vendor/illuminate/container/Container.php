...
namespace PHPStanBodyscan202405\Illuminate\Container;

use ArrayAccess;
use Closure;
use Exception;
use PHPStanBodyscan202405\Illuminate\Contracts\Container\BindingResolutionException;
use PHPStanBodyscan202405\Illuminate\Contracts\Container\CircularDependencyException;
use PHPStanBodyscan202405\Illuminate\Contracts\Container\Container as ContainerContract;
use LogicException;
use ReflectionClass;
