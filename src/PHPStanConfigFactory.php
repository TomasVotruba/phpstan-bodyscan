...
use PHPStanBodyscan202406\Nette\Neon\Neon;
...
final class PHPStanConfigFactory
{
     ...
     */
    public function create(string $projectDirectory, array $extraConfiguration = [], bool $bare = \false, bool $isNoIgnore = \false) : PHPStanConfig
    {
        ...
        // keep original setup
        if ($bare === \false) {
            $phpStanNeonContents = $this->loadFileAndMergeParameters($existingPHPStanFile, ['parameters' => [
     ...
     */
    private function loadFileAndMergeParameters(string $existingPHPStanFile, array $extraContents, bool $isNoIgnore) : string
    {
